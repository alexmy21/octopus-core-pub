...
//    private static final String DEFAULT_NAME = "ПСС";
//    private static final String DEFAULT_DESCRIPTION = "Простое скользящее среднее";
//    private static final String DEFAULT_WINDOW_LENGTH_DESCRIPTION = "Количество наблюдаемых значений";
//    private static final String DEFAULT_INPUT_DESCRIPTION = "Поступающая на вход последовательность" +
//            " которую ПСС будет усреднять.";
//    private static final String DEFAULT_OUTPUT_DESCRIPTION = "Название атрибута, который получаем" +
//            " на выходе.";
